import {  DownloadCloud, ImageIcon, Loader2Icon } from "lucide-react";
...
const PreviewPanel = ({thumbnail,isLoading,aspectRatio}:{thumbnail:IThumbnail | null,isLoading:boolean;aspectRatio:AspectRatio}) => {
     ...
     const onDownload = ()=>{
        ...
        link.href = thumbnail?.image_url.replace('/upload','upload/fl_attechment')
  ...
  return (
    <div className="relative mx-auto w-full max-w-2xl ">
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}` }>
        {/* Loading state */}
        {isLoading && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/25 gap-4 ">
