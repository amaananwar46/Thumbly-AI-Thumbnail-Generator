...
//                     </a>
//                 </div>
//                 <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">Thumbly - amaananwar</a></p>
//             </motion.div>
//         </footer>
//     );
// }
    ...
    <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
      ...
      >
        <p className="max-w-60">
          AI-powered thumbnail generation platform built with React,
          TypeScript, Node.js, Express and MongoDB.
        </p>

        <div className="flex items-center gap-4 mt-3">
          <a
            href="https://github.com/amaananwar46"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://linkedin.com/in/amaan-anwar"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a href="mailto:amaananwar46@gmail.com">
            <MailIcon className="size-5 hover:text-pink-500 transition" />
          </a>
        </div>

        <p className="mt-3 text-center">
          © {new Date().getFullYear()} Thumbly — Built by Amaan Anwar
        </p>
      </motion.div>
    </footer>
  );
