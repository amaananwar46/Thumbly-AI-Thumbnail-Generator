...
const Generate = () => {
  ...
  try {
    ...
    "Thumbnail generation service is temporarily unavailable. Please try again later."
                   ...
                   <div className="space-y-5">
                    {/* title input */}
                     ...
                     <div className="space-y-2">
                      ...
                      <textarea value={additionalDetails} onChange={(e)=>setAdditionalDetails(e.target.value)} rows={3} placeholder="Add any specific elements, mood, or style preference... " className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none"></textarea>
                     </div>
